	...
	<body>
		<div class="container">
            ...
            <form action="https://hcysa2.mercury.nottingham.edu.my/hcykn3/sakila/logout.php"><input type="submit" value="Sign out" style="float: right"/> </form>
        		...
        		<form action="insert.php"><input type="submit" value="Insert new country" style="float: right"/> </form>
			</div>
			<br />
			<br />
			<div class="form-group">
				<div class="input-group">
					...
					<input type="text" name="search_text" id="search_text" placeholder="by country ID, country name or last update" class="form-control abc" />
				</div>
			</div>
			<br />
...
$(document).ready(function(){
	...
	{
		$.ajax({
			url:"https://hcysa2.mercury.nottingham.edu.my/hcykn3/sakila/country/fetch.php",
			method:"post",
			data:{query:query},
