	...
	<body>
		<div class="container">
        	...
        	<div>
        		...
        		<form action="https://hcysa2.mercury.nottingham.edu.my/hcykn3/sakila/address/insert.php"><input type="submit" value="Insert new address" style="float: right"/> </form>
			</div>
			<br />
			<br />
			<div class="form-group">
				<div class="input-group">
					...
					<input type="text" name="search_text" id="search_text" placeholder="by address ID, address, address 2, district, city ID, postal code, phone or last update" class="form-control abc" />
				</div>
			</div>
			<br />
...
$(document).ready(function(){
	...
	{
		$.ajax({
			url:"https://hcysa2.mercury.nottingham.edu.my/hcykn3/sakila/address/fetch.php",
			method:"post",
			data:{query:query},
