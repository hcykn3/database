	...
	<body>
		<div class="container">
        	...
        	<div>
        		...
        		<form action="../city/insert.php"><input type="submit" value="Insert new city" style="float: right"/> </form>
			</div>
			<br />
			<br />
			<div class="form-group">
				<div class="input-group">
					...
					<input type="text" name="search_text" id="search_text" placeholder="by city ID, city name, country ID or last update" class="form-control abc" />
				</div>
			</div>
			<br />
...
$(document).ready(function(){
	...
	{
		$.ajax({
			url:"https://hcysa2.mercury.nottingham.edu.my/hcykn3/sakila/city/fetch.php",
			method:"post",
			data:{query:query},
