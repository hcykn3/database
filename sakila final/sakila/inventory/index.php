...
<div class="bar">
  <button class="w3-button bar w3-xlarge" onclick="w3_open()">☰</button>
	...
	<body>
		<div class="container">
        	...
        	<div>
        		...
        		<form action="../inventory/insert.php"><input type="submit" value="Insert new inventory" style="float: right"/> </form>
			</div>
			<br />
			<br />
