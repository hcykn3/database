...
<html>
	...
	<body>
		<div class="container">
			<br />
			<br />
			<h1 align="center">Language</h1><br />
        	<div>
        		...
        		<form action="../language/insert.php"><input type="submit" value="Insert new language" style="float: right"/> </form>
			</div>
			<br />
			<br />
