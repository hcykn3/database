...
<html>
	...
	<body>
		<div class="container">
			<br />
			<br />
			<h1 align="center">Customer</h1><br />
        	<div>
        		...
        		<form action="../customer/insert.php"><input type="submit" value="Insert new customer" style="float: right"/> </form>
			</div>
			<br />
			<br />
			<div class="form-group">
				<div class="input-group">
					...
					<input type="text" name="search_text" id="search_text" placeholder="by customer ID, store ID, first name, last name, email, address ID, create date or last update" class="form-control abc" />
				</div>
			</div>
			<br />
