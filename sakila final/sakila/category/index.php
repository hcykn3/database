	...
	<body>
		<div class="container">
        	...
        	<div>
        		...
        		<form action="../category/insert.php"><input type="submit" value="Insert new category" style="float: right"/> </form>
			</div>
			<br />
			<br />
			<div class="form-group">
				<div class="input-group">
					...
					<input type="text" name="search_text" id="search_text" placeholder="by category ID, category name or last update" class="form-control abc" />
				</div>
			</div>
			<br />
...
$(document).ready(function(){
	...
	{
		$.ajax({
			url:"https://hcysa2.mercury.nottingham.edu.my/hcykn3/sakila/category/fetch.php",
			method:"post",
			data:{query:query},
