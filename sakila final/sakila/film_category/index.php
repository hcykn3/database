...
<html>
	...
	<body>
		<div class="container">
			<br />
			<br />
			<h1 align="center">Film Category</h1><br />
        	<div>
        		...
        		<form action="../film_category/insert.php"><input type="submit" value="Insert new film category" style="float: right"/> </form>
			</div>
			<br />
			<br />
