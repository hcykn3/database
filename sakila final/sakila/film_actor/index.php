...
<html>
	...
	<body>
		<div class="container">
			<br />
			<br />
			<h1 align="center">Film Actor</h1><br />
        	<div>
            <form action="https://hcysa2.mercury.nottingham.edu.my/hcykn3/sakila/logout.php"><input type="submit" value="Sign out" style="float: right"/> </form>
        		...
        		<form action="../film_actor/insert.php"><input type="submit" value="insert new film actor" style="float: right"/> </form>
			</div>
			<br />
			<br />
